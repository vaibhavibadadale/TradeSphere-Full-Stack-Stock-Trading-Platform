  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className=""><i class="fa-regular fa-circle-user fa-sm"></i>Your Zerodha Account</h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className=""><i class="fa-solid fa-money-bill fa-sm"></i>Funds</h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className=""><i class="fa-solid fa-circle-notch fa-sm"></i>Console</h4>
